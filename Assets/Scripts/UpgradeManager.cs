...
public class UpgradeManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Upgrades.Add(new Upgrade("Scavenger", "Increases the amount of scrap you get from enemies", 1, (p) => { WorldManager.Instance.BonusScrapChance += 0.05f; }));
    ...
    void AddDroneUpgrades()
    {
        ...
        Upgrades.Add(new Upgrade("Drone Fire Rate", "Drones will fire faster", 2, (p) => { p.Upgrade_DroneFireRate(); }));
        Upgrades.Add(new Upgrade("Drone Damage", "Drones will do more damage", 2, (p) => { p.Upgrade_DroneDamage(); }));
